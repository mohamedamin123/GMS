...
public class BonS extends Bon {
		...
		super();
		 ...
		 try {
				Class.forName("com.mysql.cj.jdbc.Driver");
				 ...
				 rs=st.executeQuery("select * from bons order by refBS");
	     ...
	     p.setBounds(0, 150, 500, 500);
		  add(p);
		setTitle("Listes de Bon Sorties");
		super.l01.setText("Liste de Bons Sorties");
		 try {
				Class.forName("com.mysql.cj.jdbc.Driver");
				db=DriverManager.getConnection("jdbc:mysql://localhost/dbstock", "root", "");
								...
								l02.setBounds(180, 5, 125, 125);
							     ...
							     cb.addActionListener(new ActionListener() {
									...
									bt3.setBounds(325, 90, 100, 25);
									  ...
									  for(lm=0;lm<nb14;lm++)
									  {  
										  System.out.println(tab.getValueAt(10, 0));
									...
									bt3.addActionListener(new ActionListener() {
										...
										public void actionPerformed(ActionEvent e) {
											try {
									            ...
									            st.executeUpdate("update bons set dateS='"+t001.getText()+"',nomS='"+jc2.getSelectedItem()+"',typeS='"+tab66.getValueAt(m, 0)+"',calibre='"+tab66.getValueAt(m, 1)+"',qte='"+tab66.getValueAt(m, 2)+"' where idBS='"+t2.getText()+"'and refBS='"+tab.getValueAt(ll,1)+"'");
												ll++;
												}
												db.close();
									...
									f.getContentPane().setBackground(new Color(164, 194, 244));				
									  tab66.setBackground(Color.WHITE);
									     ...
									     tab66.setFont(new Font(Font.SANS_SERIF,Font.BOLD,12));
		 ...
		 getContentPane().setBackground(new Color(164, 194, 244));
		    ...
		    tab.setFont(new Font(Font.SERIF,Font.BOLD,10));
	...
	public void supprimer()
	{
		int i = tab.getSelectedRow();
		  t001.setText((String)tab.getValueAt(i, 1));
		  t2.setText((String)tab.getValueAt(i, 0));
		  jc2.setSelectedItem(tab.getValueAt(i, 2));
        tab66.setValueAt(tab.getValueAt(i, 3), 0, 0);
        tab66.setValueAt(tab.getValueAt(i, 4), 0, 1);
        tab66.setValueAt(tab.getValueAt(i, 5), 0, 2);
      ...
      try {
			...
			st.executeUpdate("delete from  bons where refBS='"+tab.getValueAt(i, 1)+"'");
